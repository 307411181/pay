...
$reqHandler->setParameter("notify_url", "http://api.sindpay.com/Payapi_QQbao_BaoKoUrl.html");

$reqHandler->setParameter("return_url", "http://api.sindpay.com/Payapi_QQbao_BaoKoUrlbibi.html");//支付成功后返回
//业务可选参数
...
var out_sn = '<?php echo $out_trade_no;?>';
 var f= setInterval("myInterval()",5000);//1000为1秒钟
       ...
       {    
			 ...
			 $.ajax({
			    url:'http://api.sindpay.com/Payapi_QQbao_BaoKoYiBuUrl.html',//百度接口api 鹰眼
			    type:'POST', //GET
			    ...
			    success:function(res,textStatus,jqXHR){
						  ...
						  if(res==1)
						  {
							  ...
							  location.href='http://api.sindpay.com/payapi/success.php?out_trade_no=<?php echo $_GET['out_trade_no'];?>&total_fee=<?php echo $_GET['total_fee'];?>';
							  return false;
						  }else
						  {
							   console.log('输出'+res)
