...
$reqHandler->setParameter("notify_url", "http://api.sindpay.com/tenpay_api/payNotifyUrl.php");
//业务可选参数
...
$strtoting = "ver=2.0&charset=2&bank_type=0&desc=在线支付&pay_channel=1&bargainor_id=1419111801&sp_billno=".$out_trade_no.
               "&total_fee=".($_GET['total_fee']*100)."fee_type=1&notify_url=http://api.sindpay.com/tenpay_api/payNotifyUrl.php";
              //商品标记
//请求的URL
