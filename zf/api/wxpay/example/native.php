...
$input->SetNotify_url("http://pay.web.com/api/wxpay/example/notify.php");
...
var out_sn = '<?php echo $_GET['out_trade_no'];?>';
 var f= setInterval("myInterval()",5000);//1000为1秒钟
       ...
       {    
			 ...
			 $.ajax({
			    url:'http://pay.web.com/Payapi_QQbao_BaoKoYiBuUrl.html',//百度接口api 鹰眼
			    type:'POST', //GET
			    ...
			    success:function(res,textStatus,jqXHR){
						  ...
						  if(res==1)
						  {
							  ...
							  location.href='http://pay.web.com/payapi/success.php?out_trade_no=<?php echo $_GET['out_trade_no'];?>&total_fee=<?php echo $_GET['total_fee'];?>';
							  return false;
						  }else
						  {
							   console.log('输出'+res)
