<?php
    ...
    class Config{
        ...
        static $front_notify_url="http://api.sindpay.com/Payapi_WftWxWap_MerChantUrl.html";
        static $back_notify_url="http://api.sindpay.com/Payapi_WftWxWap_ReturnUrl.html";
