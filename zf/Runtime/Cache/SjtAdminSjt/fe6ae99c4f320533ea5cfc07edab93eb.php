...
<body>
<form name="Form1" method="post" action="/SjtAdminSjt_News_addnews_type_<?php echo ($_GET['type']); ?>.html" onsubmit="return check()">
<div id="titlediv">

标题：

<input type="text" name="title" id="title">&nbsp;&nbsp;&nbsp;&nbsp;
<input type="checkbox" name="zt" value="1" id="zt">&nbsp;<span id="pbspan">屏蔽信息</span>
</div>
<div class="tj">
...
<div class="tj" style="margin-top:120px;">
<input type="submit" value="添 加">&nbsp;&nbsp;&nbsp;&nbsp;
<input type="reset" value="重 置">
</div>
</form>
