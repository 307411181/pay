...
$(document).ready(function(e) {
    $("#SearchButton").click(function(e) {
        window.location.href = "/SjtAdminSjt_Tikuan_wttkjl_T_<?php echo ($_GET['T']); ?>.html?sq_date="+$("#sq_date").val()+"&sq_date_js="+$("#sq_date_js").val()+"&zt="+$("#zt").val()+"&pagepage="+$("#pagepage").val();
    });
...
function daochu(){
	...
	window.open("/SjtAdminSjt_Tikuan_ExportExcel.html?sq_date="+$("#sq_date").val()+"&sq_date_js="+$("#sq_date_js").val()+"&zt="+$("#zt").val()+"&T=<?php echo ($_GET['T']); ?>&wt=1&listcheckbox="+listcheckbox);
	}
	}
</script>
</head>
