...
$(document).ready(function(e) {
    $("#SearchButton").click(function(e) {
        window.location.href = "/SjtAdminSjt_Jilu_ptzzjl.html?sq_date="+$("#sq_date").val()+"&sq_date_js="+$("#sq_date_js").val()+"&pagepage="+$("#pagepage").val();
    });
...
<body>
 <div class="selectclass" style="height:auto;">
    ...
    <!--  <td>当日总额：<span style="font-size:20px; color:#F00; font-weight:bold;"><?php echo ($daymoney); ?></span> 元</td>
      ...
      <td>当日成功转账：<span style="font-size:20px; color:#F00; font-weight:bold;"><?php echo ($daynum); ?></span> 笔</td>
     ...
     <!-- <td>昨日总额：<span style="font-size:20px; color:#F00; font-weight:bold;"><?php echo ($zmoney); ?></span> 元</td>
      ...
      <td>昨日成功转账：<span style="font-size:20px; color:#F00; font-weight:bold;"><?php echo ($znum); ?></span> 笔</td>
      <td>昨日利润：<span style="font-size:20px; color:#F00; font-weight:bold;"><?php echo ($zlrmoney); ?></span> 元</td>
      </tr>
      </table>
      </div>
      <div class="listmenu" style="text-align:left; display:none;">
...
<td style="color:#0C0"><?php echo ($vo["Username"]+10000); ?></td>
<td><?php echo ($vo["sxfmoney"] + $vo["OrderMoney"]); ?>&nbsp;</td>
