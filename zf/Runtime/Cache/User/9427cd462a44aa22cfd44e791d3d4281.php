   ...
   $("#tkyh").val(<?php echo ($mrbankid); ?>);
								...
								<tr>
									<td colspan="2"
										...
										<a href="/User_Index_tkyh_banktype_0.html"><button type="button" class="btn btn-primary">
											请您先添加收款账号，才能提现！
											</button></a>
...
<script type="text/javascript" src="http://api.sindpay.com/Public/User/js/tktx.js?v=1483687757"></script><script type="text/javascript">
