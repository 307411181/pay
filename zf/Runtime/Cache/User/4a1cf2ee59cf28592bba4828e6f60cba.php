...
<?php if(($ytjtkyh < $wtyh) or ($banktype == 0)): ?><div class="jbxx"><input type="hidden" name="UserID" id="UserID" value="<?php echo ($_SESSION['UserID']); ?>">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
    <?php if($banktype == 0): ?><span class="tsts"><input type="checkbox" name="moren" id="moren" value="1" style="vertical-align:middle" checked="checked"/> <!--<span style="cursor:pointer;" onclick="javascript:morenselect();">默认提款账户</span>--></span><?php endif; ?>支付宝用户请填写"支付宝"
    </div>
    <div class="jbxx">
	...
	<img src="/Public/User/images/fh.gif" onclick="javascript:history.go(-1);" style="vertical-align:middle; cursor:pointer;"><?php endif; ?>
      <!----------------------------------------------------------------------------------->
      <?php else: ?>
      <!--------------------------------------------------------------------------------->
