<?php if (!defined('THINK_PATH')) exit();?><element>
  ...
  <div class="sidebar-nav navbar-collapse">
    <ul class="nav" id="side-menu">
      ...
      <ul class="nav nav-second-level">
	    <li><a href="/User_Index_basic.html">基本信息 </a></li>
       <li><a href="User_Index_shjk.html"> 接口信息 </a> </li>
       <li><a href="User_Index_shtd.html"> 通道信息 </a> </li>
        <li><a href="User_Index_skym.html">收款主页</a></li>
	  ...
	  <li>  <a href="#"> <i class="fa fa-user fa-fw"></i> 分润管理 <span class="fa arrow"></span> </a>
        <ul class="nav nav-second-level">
  ...
  <li><a href="/Index_regstep.html?regcode=<?php echo ($_SESSION['UserID']); ?>&regtype=1" target="_blank">注册下级商户</a></li>
	...
	<!--   <?php switch($_SESSION['UserType']): case "5": ?>-->  
 ...
 &nbsp;&nbsp;代理推广链接：<a href="/Index_regstep.html?regcode=<?php echo ($_SESSION['UserID']); ?>&regtype=1" target="_blank">http://<?php echo C("WEB_URL");?>/Index_regstep.html?regcode=<?php echo ($_SESSION['UserID']); ?>&regtype=1</a>【发送链接给下级注册】 
 <?php switch($_SESSION['UserType']): case "5": break; endswitch;?> 
    ...
    <div class="panel-footer"> 当日订单数量： <strong></strong><?php echo ($dayorder); ?>
      笔&nbsp;&nbsp;/&nbsp;&nbsp;当前余额:<?php echo ($Money); echo ($daymoney); ?> <strong></strong> 元&nbsp;&nbsp;/&nbsp;&nbsp;银行卡：<?php echo ($BankName); ?> <strong></strong> &nbsp;&nbsp;/&nbsp;&nbsp;已提现金额:<?php echo ($ytxmoney); ?> 元 </div>
							...
							<span style="color:#48A981;float: right; font-size: 13px;">
