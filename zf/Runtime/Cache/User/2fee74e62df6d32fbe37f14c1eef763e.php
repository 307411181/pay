<?php if (!defined('THINK_PATH')) exit();?><element>
	...
	<html>
		<head>
			...
			<link href="http://cdn.bootcss.com/font-awesome/4.7.0/css/font-awesome.css?v=1483670719"  rel="stylesheet">
							...
							<div class="list-group">
								<a href="#"
									...
									平台公告
										    ...
										    <?php if(is_array($listgg)): $i = 0; $__LIST__ = $listgg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/User_Index_sjtggshow_newsid_<?php echo ($vo["id"]); ?>.html" class="list-group-item" ><?php echo ($vo["title"]); ?>
