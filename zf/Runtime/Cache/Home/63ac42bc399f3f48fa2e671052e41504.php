...
<title><?php echo C("WEB_NAME");?>-为站长和开发者提供聚合多种支付通道</title>
<meta name="keywords" content="<?php echo C("WEB_NAME");?>,第四方支付,支付解决方案,移动互联网计费专家,一站式提供国内外专业的计费解决方案,手游计费,O2O计费,一键支付,聚合支付" />
<meta name="description" content="<?php echo C("WEB_NAME");?>,只需一个账号,轻松获得多种支付通道（微信支付、支付宝、QQ钱包、财付通、银联）,致力于为个人以及企业站长、个人及企业开发团队提供安全、便捷、专业、简单的第四方在线支付交易服务。" />
...
<header>
<div class="logo">
  <a href="/index.php"><img src="static/picture/logo.png" alt="首页"class="img-responsive" />
  </a>
        </div>
        ...
        <nav class="menu">
          <ul class="list-inline">
            ...
            <li><a>关于</a></li>
            <li><a>联系</a></li>
            <li><a href="http://<?php echo C("WEB_URL");?>/index_login.html">进入商户平台</a></li>
          </ul>
        </nav>
         <div class="hotline">
         </div> 
        <div class="menu-icon">
  			<a href="tel:134-2828-4468" title="点击直拨"><span class="glyphicon glyphicon-earphone"></span></a>
        ...
        <div class="swiper-container items">
           <div class="swiper-wrapper">
                 <div class="swiper-slide">
                    <a href="http://<?php echo C("WEB_URL");?>/index_login.html">
                    <img src="/static/picture/11.jpg" alt="" href="http://<?php echo C("WEB_URL");?>/index_login.html"/>
                    <p><strong>支付通道代开</strong><br />让您省去繁琐步骤，一次申请通过</p></a>
                  </div>
<div class="swiper-slide">
                    <a href="http://<?php echo C("WEB_URL");?>/index_login.html">
                    <img src="static/picture/22.jpg" alt="" href="http://<?php echo C("WEB_URL");?>/index_login.html"/>
    ...
    <section class="aboutus">
        ...
        <div class="swiper-container items">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide nth2">
              	<strong>南充天牛信息技术有限公司</strong>
                <p>南充天牛信息技术有限公司坐落在“顺庆府”四川南充，注册资金80万。公司员工人数约60人，其中技术人员占总员工人 数比例的30%，拥有多名软件开发、通讯技术工程师，业务团队占总员工人数比例的50%，超过90%以上的员工已达到大专以上学历，是充满着激情和创意思维，且拥有多年互联网从业经验的团队。</p>           
              </div>          
            </div>
        </div>     
    </section>
    <section class="contact">
    	<div class="box">
        	<div class="above">
                ...
                <div class="left">
                	<span style="color:#2fb8f7;font-size:20px;font-weight:700;"><?php echo C("WEB_COMPANY");?></span>
<br/>
                <p>24小时服务电话：13428284468<br />服务QQ：16132626<br>邮编：637000</p>
                </div>
                 <div class="right">
                	 <br>地址：深圳市民治区民治街道牛栏大厦 <br />Copyright©2014-2016 All Rights Reserved <br>
                	  <a href="http://www.miitbeian.gov.cn/">粤ICP备16033332号-2</a>
                </div>
            </div>

<a id="jsl_speed_stat0" href="http://www.yunaq.com/#zid=" target="_blank">知道创宇云安全</a><script src="//static.yunaq.com/static/js/stat/picture_stat.js" charset="utf-8" type="text/javascript"></script>
        </div>
    </section>
    ...
    <div class="dock">
        <ul class="icons">
        	<li class="up"><i></i></li>
            <li class="im">
            	<i></i><p>天牛支付<br />在线沟通，请点我<a href="http://wpa.qq.com/msgrd?v=3&uin=16132626&site=qq&menu=yes" target="_blank">在线咨询</a></p>
            </li>
            <li class="tel">
            	<i></i><p>咨询热线：<br />13428284468<br />售后电话：<br />13428284468</p>
            </li>
            <li class="wechat">
