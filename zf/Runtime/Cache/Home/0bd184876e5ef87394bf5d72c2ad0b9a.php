...
<style type="text/css">
.in-login{left:50%;margin-left:-160px;top:30%; padding-top: 10px;}
</style>
  ...
  <div class="box">
    ...
    <form class="form-horizontal" name="Form1" method="post" action="" onsubmit="return check();">
          ...
          <div class="in-login-con">
            <div class="zhdl"> <strong>商户登录</strong> <strong>
		 ...
		 <div class="dlan_reg">
              ...
              <a href="http://<?php echo C("WEB_URL");?>/Index_denglugr.html" id="corp_loginbtn" class="dlan-input">代理登录</a>
            </div> 
 <div class="dlan_reg">
              
              <a href="http://<?php echo C("WEB_URL");?>/Index_reg.html" id="corp_loginbtn" class="dlan-input">注册账号</a>
            </div> 
