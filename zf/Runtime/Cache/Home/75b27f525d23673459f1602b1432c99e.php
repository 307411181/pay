...
<div class="logo">
 ...
 <form class="form-horizontal" name="Form1" method="post" action="" onsubmit="return check();">
   ...
   <div id="dengludiv">
       <div id="dengludivtitle">&nbsp;&nbsp;商户登录</div>
       <div id="dengludivts">
       ...
       <div id="dengludivcontent">
                 ...
                 <div style="clear:left;"></div>
                  <div class="form-group" style="margin-top:20px;">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-primary">商户登录</button>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/Index_mmzh.html" style="text-decoration:none; color:#3584c5; font-size:12px;">忘记密码?</a>
                    </div>
                  </div>
            ...
            <div id="dengludivcontentright">
               ...
               <button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<?php echo U("Index/denglugr");?>'">代理登录</button>
            </div>
       </div>
   </div>
