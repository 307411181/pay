...
<div class="zcx zc">
   <div style="width:100%; height:119px; line-height:30px; font-size:30px; color:#039; margin-top:50px;"><p style="font-weight:bold; margin-top:10px;">企业注册</p>
...
<span style="font-size:13px; margin-left:30px;  font-weight:normal; color:#333">首家通过国家信息安全认证，保障交易安全</span>
   ...
   <div><img src="/Public/images/qy_reg.gif" style="border:0px; cursor:pointer; padding-bottom: 50px;" reg="/Public/images/qy_reg.gif" UserType="1" id="regcodeclick"></div>
</div>
<div style="margin-left:10px;" class="zcx zc">
 <div style="width:100%; height:119px; line-height:30px; font-size:30px; color:#F60;margin-top:50px;"><p style="font-weight:bold; margin-top:10px;">个人注册</p>
 ...
 <span style="font-size:13px; margin-left:30px;  font-weight:normal; color:#333">会员支付、免费转账等功能</span>
    ...
    <div><img src="/Public/images/gr_reg.gif" style="border:0px; cursor:pointer; padding-bottom: 50px;" reg="/Public/images/gr_reg.gif" UserType="0"></div>
</div>
...
<form name="Form1" id="Form1" method="post" action="/Index_regdaili.html" onsubmit="return check()">
<div style="width:760px; height:482px; margin:0px auto; margin-top:10px; display:none; " id="regdiv">
...
上级编号：<span class="text-danger" style="font-weight:bold"><?php echo ($shh); ?></span>
</div><?php endif; ?>
<div class="regtitle reginput">
账户名称：<input type="text" name="UserName" id="UserName" style="width:200px; height:25px; vertical-align:middle; font-size:20px; color:#06C;" class="inputtext">&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:13px; color:#666;">账户只能用Email邮箱地址</span>
...
<div class="regtitle reginput">
&nbsp;&nbsp;&nbsp;&nbsp;验证码：<input type="text" name="verify" id="verify" style="width:200px; height:25px; vertical-align:middle; font-size:20px; color:#06C;" class="inputtext">
